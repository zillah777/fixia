                            ...
                            {[
                                ...
                                >
                                    <div className="h-full p-5 sm:p-8 rounded-xl sm:rounded-2xl bg-white dark:bg-card border border-stone-200 dark:border-border shadow-sm hover:shadow-lg hover:shadow-current/10 transition-all duration-300 text-center overflow-hidden">
                                        <div className="absolute top-0 right-0 w-24 sm:w-32 h-24 sm:h-32 rounded-full blur-xl sm:blur-2xl opacity-0 group-hover:opacity-100 transition-opacity duration-500" style={{ backgroundColor: step.color + '33' }} />
                                        <div className="mx-auto w-12 sm:w-14 h-12 sm:h-14 rounded-lg sm:rounded-xl flex items-center justify-center mb-3 sm:mb-6 group-hover:scale-110 transition-transform duration-300 relative z-10 flex-shrink-0" style={{ backgroundColor: step.color + '26', color: step.color }}>
                                            {step.icon}
                                        </div>
                                        ...
                                        <div className="absolute -bottom-8 -right-8 w-24 h-24 rounded-full blur-xl opacity-30" style={{ backgroundColor: step.color + '4d' }} />
                                    </div>
                                    {i < 2 && (
                            ...
                            {[
                                ...
                                >
                                    <div className="flex flex-col items-center text-center p-6 rounded-xl hover:bg-white/50 dark:hover:bg-white/5 transition-colors group">
                                        <div className="w-12 sm:w-14 h-12 sm:h-14 rounded-full flex items-center justify-center mb-4 group-hover:scale-110 transition-transform duration-300" style={{ backgroundColor: step.color + '26', color: step.color }}>
                                            {step.icon}
                                        </div>
